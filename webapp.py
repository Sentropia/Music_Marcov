...
from music_generator import MAX_ORDER, MIN_ORDER, generate_midi_bytes, load_model
...
def create_app() -> Flask:
    ...
    def generate():
        ...
        try:
            midi_data = generate_midi_bytes(payload.get("order"))
        except ValueError as exc:
            return jsonify(error=str(exc)), 400
        except Exception:
            application.logger.exception("MIDI generation failed")
        ...
        response = send_file(
            ...
            mimetype="audio/midi",
            as_attachment=True,
            download_name="markov_music.mid",
            max_age=0,
        )
